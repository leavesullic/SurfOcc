...
class LoadMultiViewImageFromFiles_SemanticKitti(object):
    ...
    def __init__(self, data_config, is_train=False, img_norm_cfg=None):
        ...
        self.img_W = self.data_config['input_size'][1]
        self.img_H = self.data_config['input_size'][0]
    ...
    def get_inputs(self, results, flip=None, scale=None):
        ...
        # lidar2img
        lidar2img = torch.Tensor(results['lidar2img'][0])
        ...
        res = [img, rot, tran, intrin, post_rot, post_tran, depth, cam2lidar, lidar2img]
    ...
    def __call__(self, results):
        ...
        results['img_shape'] = [(self.img_H, self.img_W)]
