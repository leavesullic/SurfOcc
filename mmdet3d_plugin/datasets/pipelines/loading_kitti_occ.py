...
class LoadSemKittiAnnotation():
    ...
    def forward_test(self, results):
        ...
        imgs, rots, trans, intrins, post_rots, post_trans, gt_depths, cam2lidar, lidar2img = results['img_inputs']
        results['img_inputs'] = (imgs, rots, trans, intrins, post_rots, post_trans, bda_rot, gt_depths, cam2lidar, lidar2img)
