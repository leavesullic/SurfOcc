...
class CreateDepthFromLiDAR(object):
    def __init__(self, data_root=None, dataset='kitti'):
        ...
        assert self.dataset in ['kitti', 'nuscenes']
    ...
    def __call__(self, results):
        ...
        if self.dataset == 'kitti':
            imgs, rots, trans, intrins, post_rots, post_trans, _, cam2lidar, lidar2img = results['img_inputs']
            results['img_inputs'] = imgs, rots, trans, intrins, post_rots, post_trans, gt_depths, cam2lidar, lidar2img
        else:
            imgs, rots, trans, intrins, post_rots, post_trans, _, cam2lidar = results['img_inputs']
            results['img_inputs'] = imgs, rots, trans, intrins, post_rots, post_trans, gt_depths, cam2lidar
