...
class PerceptionTransformer(BaseModule):
    ...
    def refine_vox_feat(
        ...
        unmasked_ref_3d = torch.from_numpy(ref_3d[vox_coords[unmasked_idx[0], 3], :]).float()
        ...
        # print("in transformer mlvl", feat_flatten.shape)
    ...
    # def diffuse_bev_feat(
    #         self,
    #         bev_feat,
    #         bev_anchor
    # ):
    #
    #     # masked auto encoder at BEV
    #     bev_feat = self.masked_auto_encoder(bev_feat, bev_anchor)
    #
    #     return bev_feat
